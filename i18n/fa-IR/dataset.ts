const translation = {
  ...
  intro1: 'دانش می‌تواند در برنامه Butterfly ',
  ...
  externalAPIPanelDescription: 'API دانش خارجی برای اتصال به یک پایگاه دانش خارج از Butterfly و بازیابی دانش از آن پایگاه دانش استفاده می شود.',
