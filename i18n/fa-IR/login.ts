const translation = {
  ...
  welcome: 'به Butterfly خوش آمدید، لطفا برای ادامه وارد شوید.',
  email: 'آدرس ایمیل',
  ...
  license: {
    tip: 'قبل از شروع Butterfly Community Edition، GitHub را بخوانید',
    link: 'مجوز منبع باز',
  },
  join: 'عضویت',
  joinTipStart: 'شما را دعوت می‌کنیم به',
  joinTipEnd: 'تیم در Butterfly',
  invalid: 'لینک منقضی شده است',
  explore: 'کاوش Butterfly',
  ...
  resetPasswordDesc: 'ایمیلی را که برای ثبت نام در Butterfly استفاده کرده اید تایپ کنید و ما یک ایمیل بازنشانی رمز عبور برای شما ارسال خواهیم کرد.',
  licenseInactive: 'مجوز غیر فعال',
  licenseLost: 'مجوز گم شده است',
  licenseExpired: 'مجوز منقضی شده است',
  licenseExpiredTip: 'مجوز Butterfly Enterprise برای فضای کاری شما منقضی شده است. لطفا برای ادامه استفاده از Butterfly با سرپرست خود تماس بگیرید.',
  licenseInactiveTip: 'مجوز Butterfly Enterprise برای فضای کاری شما غیرفعال است. لطفا برای ادامه استفاده از Butterfly با سرپرست خود تماس بگیرید.',
  licenseLostTip: 'اتصال سرور مجوز Butterfly انجام نشد. لطفا برای ادامه استفاده از Butterfly با سرپرست خود تماس بگیرید.',
}
