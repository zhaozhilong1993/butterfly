const translation = {
  ...
  welcome: 'Willkommen bei Butterfly, bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit Butterfly Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf Butterfly beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: 'Butterfly erkunden',
  ...
  resetPasswordDesc: 'Geben Sie die E-Mail-Adresse ein, mit der Sie sich bei Butterfly angemeldet haben, und wir senden Ihnen eine E-Mail zum Zurücksetzen des Passworts.',
  ...
  licenseLostTip: 'Fehler beim Verbinden des Butterfly-Lizenzservers. Wenden Sie sich an Ihren Administrator, um Butterfly weiterhin zu verwenden.',
  licenseInactive: 'Lizenz inaktiv',
  licenseInactiveTip: 'Die Butterfly Enterprise-Lizenz für Ihren Arbeitsbereich ist inaktiv. Wenden Sie sich an Ihren Administrator, um Butterfly weiterhin zu verwenden.',
  licenseExpiredTip: 'Die Butterfly Enterprise-Lizenz für Ihren Arbeitsbereich ist abgelaufen. Wenden Sie sich an Ihren Administrator, um Butterfly weiterhin zu verwenden.',
