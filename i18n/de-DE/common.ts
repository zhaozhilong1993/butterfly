const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Butterfly-Konto',
    langGeniusAccountTip: 'Ihr Butterfly-Konto und zugehörige Benutzerdaten.',
  ...
  members: {
    ...
    invitationSentTip: 'Einladung gesendet, und sie können sich bei Butterfly anmelden, um auf Ihre Teamdaten zuzugreifen.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Der OpenAI-Hostingdienst von Butterfly ermöglicht es Ihnen, Modelle wie GPT-3.5 zu verwenden. Bevor Ihr Probe-Kontingent aufgebraucht ist, müssen Sie andere Modellanbieter einrichten.',
  ...
  apiBasedExtension: {
    title: 'API-Erweiterungen bieten zentralisiertes API-Management und vereinfachen die Konfiguration für eine einfache Verwendung in Butterflys Anwendungen.',
  ...
  about: {
    ...
    nowAvailable: 'Butterfly {{version}} ist jetzt verfügbar.',
    latestAvailable: 'Butterfly {{version}} ist die neueste verfügbare Version.',
  },
  appMenus: {
    overview: 'Übersicht',
