const translation = {
  ...
  intro1: 'Wiedzę można zintegrować z aplikacją Butterfly ',
  ...
  externalAPIPanelDescription: 'Interfejs API wiedzy zewnętrznej służy do łączenia się z bazą wiedzy poza Butterfly i pobierania wiedzy z tej bazy wiedzy.',
  chunkingMode: {
