const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Konto Butterfly',
    langGeniusAccountTip: 'Twoje konto Butterfly i powiązane dane użytkownika.',
  ...
  members: {
    ...
    invitationSentTip:
      'Zaproszenie zostało wysłane, a oni mogą zalogować się do Butterfly, aby uzyskać dostęp do danych Twojego zespołu.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Usługa hostowania OpenAI dostarczana przez Butterfly pozwala korzystać z modeli takich jak GPT-3.5. Przed wyczerpaniem limitu próbnego należy skonfigurować inne dostawców modeli.',
  ...
  apiBasedExtension: {
    title:
      'Rozszerzenia oparte na interfejsie API zapewniają scentralizowane zarządzanie interfejsami API, upraszczając konfigurację dla łatwego użytkowania w aplikacjach Butterfly.',
  ...
  about: {
    ...
    nowAvailable: 'Butterfly {{version}} jest teraz dostępny.',
    latestAvailable: 'Butterfly {{version}} jest najnowszą dostępną wersją.',
  },
  appMenus: {
