const translation = {
  ...
  welcome: 'Witaj w Butterfly, zaloguj się, aby kontynuować.',
  email: 'Adres e-mail',
  ...
  license: {
    tip: 'Przed rozpoczęciem wersji społecznościowej Butterfly, przeczytaj GitHub',
    link: 'Licencję open-source',
  },
  join: 'Dołącz',
  joinTipStart: 'Zapraszam Cię do dołączenia do',
  joinTipEnd: 'zespołu na Butterfly',
  invalid: 'Link wygasł',
  explore: 'Odkryj Butterfly',
  ...
  resetPasswordDesc: 'Wpisz adres e-mail, którego użyłeś do rejestracji w Butterfly, a my wyślemy Ci wiadomość e-mail z prośbą o zresetowanie hasła.',
  or: 'LUB',
  ...
  licenseExpiredTip: 'Licencja Butterfly Enterprise dla Twojego obszaru roboczego wygasła. Skontaktuj się z administratorem, aby kontynuować korzystanie z Butterfly.',
  licenseLostTip: 'Nie udało się nawiązać połączenia z serwerem licencji Butterfly. Skontaktuj się z administratorem, aby kontynuować korzystanie z Butterfly.',
  licenseInactiveTip: 'Licencja Butterfly Enterprise dla Twojego obszaru roboczego jest nieaktywna. Skontaktuj się z administratorem, aby kontynuować korzystanie z Butterfly.',
}
