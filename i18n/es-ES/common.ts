const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Cuenta Butterfly',
    langGeniusAccountTip: 'Tu cuenta Butterfly y los datos de usuario asociados.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitación enviada, y pueden iniciar sesión en Butterfly para acceder a tus datos del equipo.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'El servicio de hospedaje OpenAI proporcionado por Butterfly te permite usar modelos como GPT-3.5. Antes de que se agote tu cuota de prueba, necesitas configurar otros proveedores de modelos.',
  ...
  apiBasedExtension: {
    title: 'Las extensiones basadas en API proporcionan una gestión centralizada de API, simplificando la configuración para su fácil uso en las aplicaciones de Butterfly.',
  ...
  about: {
    ...
    nowAvailable: 'Butterfly {{version}} ya está disponible.',
    latestAvailable: 'Butterfly {{version}} es la última versión disponible.',
  },
  appMenus: {
    overview: 'Monitoreo',
    promptEng: 'Orquestar',
