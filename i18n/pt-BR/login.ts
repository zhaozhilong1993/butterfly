const translation = {
  ...
  welcome: 'Bem-vindo ao Butterfly, faça login para continuar.',
  ...
  license: {
    tip: 'Antes de começar a usar a Edição Comunitária do Butterfly, leia a',
    link: 'Licença de código aberto do GitHub',
  },
  join: 'Participar',
  joinTipStart: 'Convidamos você a participar da',
  joinTipEnd: 'equipe no Butterfly',
  invalid: 'O link expirou',
  explore: 'Explorar o Butterfly',
  ...
  resetPasswordDesc: 'Digite o e-mail que você usou para se inscrever no Butterfly e enviaremos um e-mail de redefinição de senha.',
  sendVerificationCode: 'Enviar código de verificação',
  usePassword: 'Usar senha',
  licenseInactiveTip: 'A licença do Butterfly Enterprise para seu espaço de trabalho está inativa. Entre em contato com o administrador para continuar usando o Butterfly.',
  licenseLostTip: 'Falha ao conectar o servidor de licenças Butterfly. Entre em contato com o administrador para continuar usando o Butterfly.',
  licenseExpired: 'Licença expirada',
  licenseLost: 'Licença perdida',
  licenseInactive: 'Licença inativa',
  licenseExpiredTip: 'A licença do Butterfly Enterprise para seu espaço de trabalho expirou. Entre em contato com o administrador para continuar usando o Butterfly.',
}
