const translation = {
  ...
  plansCommon: {
    ...
    apiRateLimitTooltip: 'API Rate Limit applies to all requests made through the Butterfly API, including text generation, chat conversations, workflow executions, and document processing.',
    ...
    ragAPIRequestTooltip: 'Refers to the number of API calls invoking only the knowledge base processing capabilities of Butterfly.',
  ...
  plans: {
    ...
    community: {
      ...
      features: [
        ...
        'Single Workspace',
        'Complies with Butterfly Open Source License',
      ],
    },
    premium: {
      name: 'Premium',
    ...
    enterprise: {
      ...
      features: [
        ...
        'SSO',
        'Negotiated SLAs by Butterfly Partners',
        'Advanced Security & Controls',
        'Updates and Maintenance by Butterfly Officially',
