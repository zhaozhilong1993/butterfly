const translation = {
  ...
  promptMode: {
    ...
    advancedWarning: {
      title: 'You have switched to Expert Mode, and once you mobutterfly the PROMPT, you CANNOT return to the basic mode.',
  ...
  formattingChangedText:
    'Mobutterflying the formatting will reset the debug area, are you sure?',
  ...
  datasetConfig: {
    ...
    retrieveChangeTip: 'Mobutterflying the index mode and retrieval mode may affect applications associated with this Knowledge.',
  },
