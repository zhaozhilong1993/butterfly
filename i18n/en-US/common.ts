const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Butterfly account',
    langGeniusAccountTip: 'Your Butterfly account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Butterfly to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Butterfly allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Butterfly\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'Butterfly {{version}} is now available.',
    latestAvailable: 'Butterfly {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
