const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Or try the cloud version of Butterfly with free quote',
  },
  overview: {
    title: 'Overview',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Helps visitors understand the data the application collects, see Butterfly\'s <privacyPolicyLink>Privacy Policy</privacyPolicyLink>.',
      ...
      embedded: {
        ...
        chromePlugin: 'Install Butterfly Chatbot Chrome Extension',
        copied: 'Copied',
        copy: 'Copy',
      },
      qrcode: {
      ...
      customize: {
        ...
        way1: {
          name: 'Fork the client code, mobutterfly it and deploy to Vercel (recommended)',
          step1: 'Fork the client code and mobutterfly it',
          step1Tip: 'Click here to fork the source code into your GitHub account and mobutterfly the code',
          step1Operation: 'Butterfly-WebClient',
