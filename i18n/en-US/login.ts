const translation = {
  ...
  welcome: '👋 Welcome to Butterfly, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Butterfly Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on Butterfly',
  invalid: 'The link has expired',
  explore: 'Explore Butterfly',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on Butterfly and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The Butterfly Enterprise license for your workspace has expired. Please contact your administrator to continue using Butterfly.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect Butterfly license server. Please contact your administrator to continue using Butterfly.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The Butterfly Enterprise license for your workspace is inactive. Please contact your administrator to continue using Butterfly.',
}
