const translation = {
  ...
  marketplace: {
    ...
    discover: 'Discover',
    and: 'and',
    butterflyMarketplace: 'Butterfly Marketplace',
    ...
    viewMore: 'View more',
    verifiedTip: 'Verified by Butterfly',
    partnerTip: 'Verified by a Butterfly partner',
  },
  task: {
  ...
  butterflyVersionNotCompatible: 'The current Butterfly version is not compatible with this plugin, please upgrade to the minimum version required: {{minimalButterflyVersion}}',
}
