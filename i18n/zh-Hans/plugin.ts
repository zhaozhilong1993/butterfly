const translation = {
  ...
  marketplace: {
    ...
    discover: '探索',
    and: '和',
    butterflyMarketplace: 'Butterfly 市场',
    moreFrom: '更多来自市场',
    noPluginFound: '未找到插件',
    ...
    viewMore: '查看更多',
    verifiedTip: '此插件由 Butterfly 认证',
    partnerTip: '此插件由 Butterfly 合作伙伴认证',
  },
  task: {
  ...
  submitPlugin: '上传插件',
  butterflyVersionNotCompatible: '当前 Butterfly 版本不兼容该插件，其最低版本要求为 {{minimalButterflyVersion}}',
}
