const translation = {
  ...
  plansCommon: {
    ...
    apiRateLimitTooltip: 'API 请求频率限制涵盖所有通过 Butterfly API 发起的调用，例如文本生成、聊天对话、工作流执行和文档处理等。',
    ...
    ragAPIRequestTooltip: '指单独调用 Butterfly 知识库数据处理能力的 API。',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: [
        ...
        '多个工作空间 & 企业级管理',
        'SSO',
        '由 Butterfly 合作伙伴支持的可协商的 SLAs',
        '高级的安全 & 控制',
        '由 Butterfly 官方提供的更新 & 维护',
        '专业技术支持',
      ],
    },
  },
