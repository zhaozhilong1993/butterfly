const translation = {
  ...
  welcome: 'Bienvenue sur Butterfly, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer Butterfly Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur Butterfly',
  invalid: 'Le lien a expiré',
  explore: 'Explorez Butterfly',
  ...
  resetPasswordDesc: 'Tapez l’adresse e-mail que vous avez utilisée pour vous inscrire sur Butterfly et nous vous enverrons un e-mail de réinitialisation de mot de passe.',
  usePassword: 'Utiliser le mot de passe',
  licenseInactiveTip: 'La licence Butterfly Enterprise de votre espace de travail est inactive. Veuillez contacter votre administrateur pour continuer à utiliser Butterfly.',
  licenseLostTip: 'Échec de la connexion au serveur de licences Butterfly. Veuillez contacter votre administrateur pour continuer à utiliser Butterfly.',
  licenseExpired: 'Licence expirée',
  licenseLost: 'Licence perdue',
  licenseExpiredTip: 'La licence Butterfly Enterprise de votre espace de travail a expiré. Veuillez contacter votre administrateur pour continuer à utiliser Butterfly.',
