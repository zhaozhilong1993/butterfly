const translation = {
  ...
  intro1: 'Bilgi, Butterfly uygulamasına ',
  ...
  externalAPIPanelDescription: 'Harici bilgi API\'si, Butterfly dışındaki bir bilgi bankasına bağlanmak ve bu bilgi bankasından bilgi almak için kullanılır.',
