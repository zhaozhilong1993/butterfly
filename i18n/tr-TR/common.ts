const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Butterfly hesabı',
    langGeniusAccountTip: 'Butterfly hesabınız ve ilişkili kullanıcı verileri.',
  ...
  members: {
    ...
    invitationSentTip: 'Davet gönderildi, Butterfly\'ye giriş yaparak takım verilerinize erişebilirler.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      onTrial: 'DENEMEDE',
      exhausted: 'KOTA DOLU',
      desc: 'Butterfly tarafından sağlanan OpenAI barındırma hizmeti, GPT-3.5 gibi modelleri kullanmanıza olanak tanır. Deneme kotanız bitmeden önce, diğer model sağlayıcılarını ayarlamanız gerekir.',
  ...
  apiBasedExtension: {
    title: 'API uzantıları merkezi API yönetimi sağlar, Butterfly\'nin uygulamaları arasında kolay kullanım için yapılandırmayı basitleştirir.',
  ...
  about: {
    ...
    nowAvailable: 'Butterfly {{version}} şimdi mevcut.',
    latestAvailable: 'Butterfly {{version}} en son mevcut sürüm.',
  },
  appMenus: {
    overview: 'İzleme',
