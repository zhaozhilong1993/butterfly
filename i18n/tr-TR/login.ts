const translation = {
  ...
  welcome: 'Butterfly\'ye hoş geldiniz, devam etmek için lütfen giriş yapın.',
  ...
  license: {
    tip: 'Butterfly Community Edition\'ı başlatmadan önce GitHub\'daki',
  ...
  resetPasswordDesc: 'Butterfly\'a kaydolmak için kullandığınız e-postayı yazın, size bir şifre sıfırlama e-postası gönderelim.',
  ...
  back: 'Geri',
  licenseExpiredTip: 'Çalışma alanınız için Butterfly Enterprise lisansının süresi doldu. Butterfly\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseLostTip: 'Butterfly lisans sunucusuna bağlanılamadı. Butterfly\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseInactiveTip: 'Çalışma alanınız için Butterfly Enterprise lisansı etkin değil. Butterfly\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
