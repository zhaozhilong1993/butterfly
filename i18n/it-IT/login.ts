const translation = {
  ...
  welcome: 'Benvenuto su Butterfly, per favore accedi per continuare.',
  ...
  license: {
    tip: 'Prima di avviare Butterfly Community Edition, leggi su GitHub',
    link: 'Licenza open-source',
  },
  join: 'Unisciti',
  joinTipStart: 'Invitato a unirti al',
  joinTipEnd: 'team su Butterfly',
  invalid: 'Il link è scaduto',
  explore: 'Esplora Butterfly',
  ...
  resetPasswordDesc: 'Digita l\'e-mail che hai utilizzato per registrarti su Butterfly e ti invieremo un\'e-mail per reimpostare la password.',
  ...
  licenseLostTip: 'Impossibile connettersi al server licenze Butterfly. Contatta il tuo amministratore per continuare a utilizzare Butterfly.',
  licenseExpired: 'Licenza scaduta',
  licenseLost: 'Licenza persa',
  licenseExpiredTip: 'La licenza Butterfly Enterprise per la tua area di lavoro è scaduta. Contatta il tuo amministratore per continuare a utilizzare Butterfly.',
  licenseInactiveTip: 'La licenza Butterfly Enterprise per la tua area di lavoro è inattiva. Contatta il tuo amministratore per continuare a utilizzare Butterfly.',
