const translation = {
  pageTitle: 'はじめましょう！👋',
  welcome: 'Butterflyへようこそ。続行するにはログインしてください。',
  email: 'メールアドレス',
  ...
  license: {
    tip: 'GitHubのオープンソースライセンスを確認してから、Butterfly Community Editionを開始してください。',
    link: 'オープンソースライセンス',
  },
  join: '参加する',
  ...
  resetPasswordDesc: 'Butterflyへのサインアップに使用したメールアドレスを入力すると、パスワードリセットメールが送信されます。',
  licenseLost: 'ライセンスを失った',
  licenseExpiredTip: 'ワークスペースの Butterfly Enterprise ライセンスの有効期限が切れています。Butterflyを引き続き使用するには、管理者に連絡してください。',
  licenseInactive: 'ライセンスが非アクティブです',
  licenseInactiveTip: 'ワークスペースの Butterfly Enterprise ライセンスが非アクティブです。Butterflyを引き続き使用するには、管理者に連絡してください。',
  licenseExpired: 'ライセンスの有効期限が切れています',
  licenseLostTip: 'Butterflyライセンスサーバーへの接続に失敗しました。続けてButterflyを使用するために管理者に連絡してください。',
}
