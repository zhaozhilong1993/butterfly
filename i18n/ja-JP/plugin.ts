const translation = {
  ...
  marketplace: {
    ...
    discover: '探索',
    and: 'と',
    butterflyMarketplace: 'Butterflyマーケットプレイス',
    ...
    viewMore: 'もっと見る',
    verifiedTip: 'このプラグインはButterflyによって認証されています',
    partnerTip: 'このプラグインはButterflyのパートナーによって認証されています',
  },
  task: {
  ...
  butterflyVersionNotCompatible: '現在のButterflyバージョンはこのプラグインと互換性がありません。最小バージョンは{{minimalButterflyVersion}}です。',
}
