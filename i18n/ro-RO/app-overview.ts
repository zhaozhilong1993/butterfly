const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Sau încercați versiunea cloud a Butterfly cu cotă gratuită',
  },
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajută vizitatorii să înțeleagă datele pe care le colectează aplicația, consultați <privacyPolicyLink>Politica de confidențialitate</privacyPolicyLink> a Butterfly.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalați extensia Chrome Butterfly Chatbot',
        copied: 'Copiat',
        copy: 'Copiați',
      },
      qrcode: {
