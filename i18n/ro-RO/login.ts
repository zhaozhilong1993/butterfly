const translation = {
  ...
  welcome: 'Bine ai venit la Butterfly, te rugăm să te autentifici pentru a continua.',
  ...
  license: {
    tip: 'Înainte de a începe Butterfly Community Edition, citește',
    link: 'Licența open-source de pe GitHub',
  },
  join: 'Alătură-te',
  joinTipStart: 'Te invităm să te alături echipei',
  joinTipEnd: 'pe Butterfly',
  invalid: 'Link-ul a expirat',
  explore: 'Explorează Butterfly',
  ...
  or: 'SAU',
  resetPasswordDesc: 'Tastați e-mailul pe care l-ați folosit pentru a vă înscrie pe Butterfly și vă vom trimite un e-mail de resetare a parolei.',
  changePasswordBtn: 'Setați o parolă',
  licenseLostTip: 'Nu s-a reușit conectarea serverului de licențe Butterfly. Contactați administratorul pentru a continua să utilizați Butterfly.',
  licenseInactive: 'Licență inactivă',
  licenseInactiveTip: 'Licența Butterfly Enterprise pentru spațiul de lucru este inactivă. Contactați administratorul pentru a continua să utilizați Butterfly.',
  licenseExpired: 'Licență expirată',
  licenseLost: 'Licență pierdută',
  licenseExpiredTip: 'Licența Butterfly Enterprise pentru spațiul de lucru a expirat. Contactați administratorul pentru a continua să utilizați Butterfly.',
}
