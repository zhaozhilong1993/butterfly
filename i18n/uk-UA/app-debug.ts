const translation = {
  ...
  automatic: {
    ...
    description: 'Опишіть свій сценарій, Butterfly збере для вас застосунок.',
  ...
  datasetConfig: {
    ...
    retrieveChangeTip: 'Зміна  режиму індексування та режиму отримання може вплинути на застосунки, пов’язані з цими знаннями.', // Mobutterflying...
  },
