const translation = {
  ...
  welcome: 'Dobrodošli v Butterfly, prosimo, prijavite se za nadaljevanje.',
  ...
  license: {
    tip: 'Preden začnete z Butterfly Community Edition, preberite GitHub',
    link: 'Licenco odprte kode',
  },
  join: 'Pridruži se',
  joinTipStart: 'Vabimo vas, da se pridružite',
  joinTipEnd: 'ekipi na Butterfly',
  invalid: 'Povezava je potekla',
  explore: 'Razišči Butterfly',
  ...
  licenseExpiredTip: 'Licenca za Butterfly Enterprise za vaš delovni prostor je potekla. Če želite še naprej uporabljati Butterfly, se obrnite na skrbnika.',
  usePassword: 'Uporaba gesla',
  sendVerificationCode: 'Pošlji kodo za preverjanje',
  resetPasswordDesc: 'Vnesite e-poštni naslov, ki ste ga uporabili za prijavo na Butterfly, in poslali vam bomo e-poštno sporočilo za ponastavitev gesla.',
  ...
  licenseLostTip: 'Povezava z licenčnim strežnikom Butterfly ni uspela. Če želite še naprej uporabljati Butterfly, se obrnite na skrbnika.',
  licenseInactiveTip: 'Licenca Butterfly Enterprise za vaš delovni prostor je neaktivna. Če želite še naprej uporabljati Butterfly, se obrnite na skrbnika.',
}
