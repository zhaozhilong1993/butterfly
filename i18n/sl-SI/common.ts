const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Butterfly račun',
    langGeniusAccountTip: 'Vaš Butterfly račun in povezani uporabniški podatki.',
    editName: 'Uredi ime',
  ...
  members: {
    ...
    invitationSentTip: 'Povabilo poslano, in po prijavi v Butterfly bodo imeli dostop do vaših podatkov ekipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Gostitvena storitev OpenAI, ki jo ponuja Butterfly, vam omogoča uporabo modelov, kot je GPT-3.5. Preden porabite kvoto za preizkus, morate nastaviti druge ponudnike modelov.',
  ...
  modelProvider: {
    ...
    apiBasedExtension: {
      title: 'Razširitve API omogočajo centralizirano upravljanje API, kar poenostavi konfiguracijo za enostavno uporabo v aplikacijah Butterfly.',
      link: 'Naučite se, kako razviti svojo API razširitev.',
      linkUrl: 'https://docs.butterfly.ai/features/extension/api_based_extension',
    ...
    about: {
      ...
      nowAvailable: 'Butterfly {{version}} je zdaj na voljo.',
      latestAvailable: 'Butterfly {{version}} je najnovejša različica na voljo.',
    },
    appMenus: {
      overview: 'Nadzor',
  ...
  apiBasedExtension: {
    ...
    title: 'Razširitve API zagotavljajo centralizirano upravljanje API, kar poenostavlja konfiguracijo za enostavno uporabo v aplikacijah Butterfly.',
    linkUrl: 'https://docs.butterfly.ai/features/extension/api_based_extension',
  ...
  about: {
    updateNow: 'Posodobi zdaj',
    nowAvailable: 'Butterfly {{version}} je zdaj na voljo.',
    latestAvailable: 'Butterfly {{version}} je najnovejša različica, ki je na voljo.',
    changeLog: 'Dnevnik sprememb',
  },
  appMenus: {
