            ...
            <a
              ...
              href={
                locale === LanguagesSupported[1]
                          ? 'https://docs.butterfly.ai/v/zh-hans/guides/knowledge-base/integrate-knowledge-within-application'
        : 'https://docs.butterfly.ai/guides/knowledge-base/integrate-knowledge-within-application'
              }
...
const DatasetDetailLayout: FC<IAppDetailLayoutProps> = (props) => {
  ...
  useEffect(() => {
    if (datasetRes)
      document.title = `${datasetRes.name || 'Dataset'} - Butterfly`
  }, [datasetRes])
  ...
  return (
    <div className='flex grow overflow-hidden'>
      {!hideSideBar && <AppSideBar
        ...
        icon={datasetRes?.icon || 'https://static.butterfly.ai/images/dataset-default-icon.png'}
