...
const EducationApplyAge = () => {
  ...
  const docLink = useMemo(() => {
    if (locale === 'zh-Hans')
      return 'https://docs.butterfly.ai/zh-hans/getting-started/butterfly-for-education'
    if (locale === 'ja-JP')
      return 'https://docs.butterfly.ai/ja-jp/getting-started/butterfly-for-education'
    return 'https://docs.butterfly.ai/getting-started/butterfly-for-education'
  }, [locale])
        ...
        <div className='mx-auto max-w-[720px] px-8 pb-[180px]'>
          ...
          <div className='mb-7'>
            ...
            <div className='system-md-regular mb-1 text-text-tertiary'>
              ...
              <a href='https://butterfly.ai/terms' target='_blank' className='text-text-secondary hover:underline'>{t('education.form.terms.desc.termsOfService')}</a>&nbsp;
              {t('education.form.terms.desc.and')}&nbsp;
              <a href='https://butterfly.ai/privacy' target='_blank' className='text-text-secondary hover:underline'>{t('education.form.terms.desc.privacyPolicy')}</a>
