...
const Contribute = ({ onRefreshData }: Props) => {
  ...
  const linkUrl = useMemo(() => {
    if (language.startsWith('zh_'))
      return 'https://docs.butterfly.ai/zh-hans/guides/tools#ru-he-chuang-jian-zi-ding-yi-gong-ju'
    return 'https://docs.butterfly.ai/guides/tools#how-to-create-custom-tools'
  }, [language])
