        ...
        <div>
          ...
          <div className='mb-4 text-center text-xs font-normal text-text-secondary'>
            ...
            <div className='text-text-accent'>
              {
                IS_CE_EDITION
                  ? <Link href={'https://github.com/zhaozhilong1993/butterfly/blob/main/LICENSE'} target='_blank' rel='noopener noreferrer'>Open Source License</Link>
                  : <>
                    <Link href='https://butterfly.ai/privacy' target='_blank' rel='noopener noreferrer'>Privacy Policy</Link>,<span> </span>
                    <Link href='https://butterfly.ai/terms' target='_blank' rel='noopener noreferrer'>Terms of Service</Link>
                  </>
              }
            </div>
          </div>
        ...
        <div className='flex items-center justify-between'>
          ...
          <div className='flex items-center'>
            <Button className='mr-2'>
              <Link
                href={'https://github.com/zhaozhilong1993/butterfly/releases'}
