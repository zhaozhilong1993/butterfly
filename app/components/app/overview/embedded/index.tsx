...
<style>
  #butterfly-chatbot-bubble-button {
    background-color: ${primaryColor} !important;
  }
  #butterfly-chatbot-bubble-window {
...
const Embedded = ({ siteInfo, isShow, onClose, appBaseUrl, accessToken, className }: Props) => {
  ...
  const navigateToChromeUrl = () => {
    window.open('https://chrome.google.com/webstore/detail/butterfly-chatbot/ceehdapohffmjmkdcifjofadiaoeggaf', '_blank', 'noopener,noreferrer')
  }
