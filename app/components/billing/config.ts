...
export const contactSalesUrl = 'https://vikgc6bnu1s.typeform.com/butterfly-business'
export const getStartedWithCommunityUrl = 'https://github.com/zhaozhilong1993/butterfly'
