          ...
          description={<div className='text-xs text-text-tertiary'>
            ...
            <Link href={
              locale === LanguagesSupported[1]
                ? 'https://docs.butterfly.ai/zh-hans/guides/workflow/node/agent#xuan-ze-agent-ce-le'
                : 'https://docs.butterfly.ai/guides/workflow/node/agent#select-an-agent-strategy'
