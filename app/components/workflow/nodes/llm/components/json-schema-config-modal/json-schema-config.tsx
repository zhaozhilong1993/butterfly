...
const HELP_DOC_URL = {
  zh_Hans: 'https://docs.butterfly.ai/zh-hans/guides/workflow/structured-outputs',
  en_US: 'https://docs.butterfly.ai/guides/workflow/structured-outputs',
  ja_JP: 'https://docs.butterfly.ai/ja-jp/guides/workflow/structured-outputs',
}
