...
const PluginItem: FC<Props> = ({
  ...
  const isButterflyVersionCompatible = useMemo(() => {
    if (!langeniusVersionInfo.current_version)
      return true
    return gte(langeniusVersionInfo.current_version, declarationMeta.minimum_butterfly_version ?? '0.0.0')
  }, [declarationMeta.minimum_butterfly_version, langeniusVersionInfo.current_version])
        ...
        <div className="flex">
          ...
          <div className="ml-3 w-0 grow">
            <div className="flex h-5 items-center">
              ...
              {!isButterflyVersionCompatible && <Tooltip popupContent={
                t('plugin.butterflyVersionNotCompatible', { minimalButterflyVersion: declarationMeta.minimum_butterfly_version })
