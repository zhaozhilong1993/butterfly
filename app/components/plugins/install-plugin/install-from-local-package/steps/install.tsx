...
const Installed: FC<Props> = ({
  ...
  const isButterflyVersionCompatible = useMemo(() => {
    if (!langeniusVersionInfo.current_version)
      return true
    return gte(langeniusVersionInfo.current_version, payload.meta.minimum_butterfly_version ?? '0.0.0')
  }, [langeniusVersionInfo.current_version, payload.meta.minimum_butterfly_version])
        ...
        <div className='system-md-regular text-text-secondary'>
          ...
          {!isButterflyVersionCompatible && (
            <p className='system-md-regular flex items-center gap-1 text-text-secondary text-text-warning'>
              {t('plugin.butterflyVersionNotCompatible', { minimalButterflyVersion: payload.meta.minimum_butterfly_version })}
            </p>
          )}
        </div>
