(()=>{let t="butterflyChatbotConfig",h="butterfly-chatbot-bubble-button",m="butterfly-chatbot-bubble-window",y=window[t],a=!1,l=`
    position: absolute;
    display: flex;
    flex-direction: column;
    justify-content: space-between;
    top: unset;
    right: var(--${h}-right, 1rem); /* Align with butterfly-chatbot-bubble-button. */
    bottom: var(--${h}-bottom, 1rem); /* Align with butterfly-chatbot-bubble-button. */
    left: unset;
    width: 24rem;
